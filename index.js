...
//Nested function can access the variable internal because it is within the function so it is able to call what is in the scope and out the scope.//
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(){
    animalNames.forEach= displayName;
    scientificName.forEach= displayName;
    return displayName;
  ...
  */
  ...
  function lowerCaseNames(animal_name){
    animalNames.toLowerCase= New_animal_name;
  ...
  */
  ...
  function lowPopulationAnimals(animal_name){
    animal_name.filter= lowPopulationAnimals;
  ...
  */
  ...
  function USApop(total, animal){
    let USApop = animal_name.reduce(function (total, animal) {
      return total + animal
  }
...
function multiply(4,5){
   return 4 * 5
  }

 // 🦁🦁🦁 Use greeting to accept a first and last name and return "Hello {first-name} {last-name}, nice to meet you!" 🦁🦁🦁
  
function greeting('Paul', 'Jones'){
